...
// Importamos las imágenes de los desarrolladores desde la carpeta de imágenes
    ...
    return(
        ...
        <h1>Acerca de ClickZone</h1> 
            <p className="descripcion-proyecto">
                Bienvenido a ClickZone, tu tienda online de referencia para ropa casual y de temporada. 
                Nos dedicamos a ofrecerte las últimas tendencias y los estilos más cómodos para cada estación, 
                garantizando calidad y variedad en todas nuestras prendas. En ClickZone, encontrar el atuendo 
                perfecto para cada ocasión es fácil, rápido y divertido. ¡Explora nuestras colecciones y 
                renueva tu guardarropa con solo un clic!
            </p>
